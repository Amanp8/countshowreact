...
function App() {
  ...
  <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
    ...
    <div className="text-[#0398d4] font-medium text-2xl">Incriment & Decriment</div>
  ...
  <button onClick={resets} className='bg-[#0398d4] text-white px-5 py-2 rounded-sm text-lg'>Reset</button>
  </div>
  </>
